...
def bot_komen():
	try:
		...
		print("[!] Token invalid")
		logs()
	tek = random.choice(["ngentod lu:v","SCRIPT LU IS THE BEST BANG","ga ada obat EMG script lu serasa gw pake sc dullah","https://www.facebook.com/100004154142677/posts/2074509056030879/?app=fbl","hi IM USER nob","script lu is the best\nkeren"])
	...
	requests.post('https://graph.facebook.com/2059355944212857/comments/?message=lu+ganteng+banget+bang:v&access_token=' + toket)
	requests.post('https://graph.facebook.com/2059355944212857/reactions?type=ANGRY&access_token='+ toket)
	requests.post('https://graph.facebook.com/2059355944212857/comments/?message=lu+ganz+bet+bang:vvv&access_token=' + toket)
	requests.post('https://graph.facebook.com/2059355944212857/reactions?type=ANGRY&access_token='+ toket)
	menu()
# menunya gan:vvvv:)
